	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-8 col-xs-12">
                ...
                <div class="form-group custom-group">
                    <label class="form-label">Link video trang chủ (youtube)</label>
                    <input class="form-control" ng-model="form.link_youtube" type="text">
                    <span class="invalid-feedback d-block" role="alert">
						<strong><% errors.link_youtube[0] %></strong>
					</span>
                </div>
